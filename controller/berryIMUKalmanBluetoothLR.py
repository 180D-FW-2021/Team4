...
while True:
    ...
    #With berryIMU x-axis pointed forward
    #left is a negative output, right is a positive output
    
    #maximum input angle left
    maxangL = 50
    
    #maximum input angle right
    maxangR = 45
    ...
    if (kalmanX < 0):
        kalmanX = -((-kalmanX/maxangL) ** expoL)
    else:
        kalmanX = (kalmanX/maxangR) ** expoR
